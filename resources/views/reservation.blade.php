                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex">
                                    ...
                                    >
                                        <template #openpopup>
                                            <div class="mt-4">
                                                <a @click="this.$refs['popupref2'].openPopup({{ $reservation->users()->get() }}, {{ $reservation }})"
                                                ...
                                                <div class="flex flex-col md:flex-row justify-between">
                                                    ...
                                                    <div class="md:w-5/12 w-full">
                                                        ...
                                                        <template v-if="Object.keys(slotprops.times).length > 0">
                                                            <div class="mt-4">
                                                                <label>
                                                                    Kies hier een andere tijd:
                                                                </label>
                                                                <select v-model="this.$refs['popupref2'].reservation.time"
                                                                        class="c-form__input-float">
                                                                    <option v-for="result in slotprops.times">@{{ result }}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </template>
                    ...
                    @else
                        <div>
                            ...
                            >
                                <template #openpopup>
                                    <button class="c-button c-button__blue"
                                            @click="this.$refs['popupref3'].openPopup({{ json_encode(Auth::id()) }})">
